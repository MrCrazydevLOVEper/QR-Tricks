...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/inv/inv1/assets/index.css">
</head>
<body>
    <div class="inv-wrapper"> 
        <img class="bg-img" src="<?= base_url() ?>assets/inv/inv1/assets/bg.png" alt="img-bg"> 
        <div class="dynamic-content">
            <p class="mname"><?= $info->groom ?> </p>
            <img class="spliter-img" src="<?= base_url() ?>assets/inv/inv1/assets/and.png" alt="spliter-img">
