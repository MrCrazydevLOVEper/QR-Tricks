                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="page-title-box">
                                                <h4 class="page-title">Edit Order Details</h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group row mb-0 pb-0" >
                                                         <div class="col-6"><label for="fname" class="text-left control-label col-form-label" >Order Number</label> </div>
                                                         <div class="col-6 order_no_value" ></div>
                                                         <div class="col-6"><label for="fname" class="text-left control-label col-form-label" >Order Date</label> </div>
                                                         <div class="col-6 ordered_date_value"></div>
<!--                                                     <label for="fname" class="text-left control-label col-form-label" >Select Customer</label>
                                                    <select name="user_unique_id" id="user_unique_id" placeholder="Customer List">
                                                        ...
                                                        {
                                                        echo "<option value=".$value['user_unique_id'].">".$value['user_full_name']."</option>";
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="form-group mb-0 row mt-2" style="background-color: #f3f7f9;border-radius: 5px">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group mb-0 Requestproductshow" style="display: none;">
                                                            ...
                                                            <input type="hidden" class="form-control" name="user_unique_id" id="user_unique_id" placeholder="Enter Product Name">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="border-top">
                                                            <div class="card-body" style="float:right;">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="addproductsbtnn">Add Product</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-8">
                                                ...
                                                <tr class="promocode_display" style="display: none;">
                                                    <td scope="row" colspan="3" style="border:none" class="text-right"></td>
                                                    <th scope="row" class="text-right" style="background: #f3f7f9;">Promo Discount </th>
                                                    <td style="background: #f3f7f9;" colspan="2"><div class="col-sm-12 font-weight-bold">
                                                        <input class="form-control  numbersOnly" style="border:none"  readonly id="order_promo_discount" name="order_promo_discount" >
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="pricerange_display" style="display: none;">
                                                    <td scope="row" colspan="3" style="border:none" class="text-right"></td>
                                                    <th scope="row" class="text-right" style="background: #f3f7f9;">Price range Discount </th>
                                                    <td style="background: #f3f7f9;" colspan="2"><div class="col-sm-12 font-weight-bold">
                                                        <input class="form-control  numbersOnly" style="border:none" readonly  id="order_price_range_discount" name="order_price_range_discount" >
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="border-top">
                                            <div class="card-body" style="float:right; display: inline-flex;">
                                                ...
                                                <button type="button" class="btn btn-primary" id="submit_fynl_order">Update Order</button>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div id="page-wrapper">
                ...
                <script src="<?php echo base_url();?>custom/edit_orders.js"></script>
