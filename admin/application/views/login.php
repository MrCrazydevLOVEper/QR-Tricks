...
<html lang="en">
    <head>
        ...
        <!-- <link rel="icon" href="<?php echo base_url(); ?>assets/img/symbol.png" /> -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div style="margin-top: 100px;" class="card bg-pattern ">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a  class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="<?php echo base_url();?>assets/img/logo png.png" alt="" width="80%">
                                            </span>
                                        </a>
                                ...
                                <form method="post" id="loginform" action="<?php echo base_url();?>AdminLoginController/login">
