! function(i) {
    ...
    e.prototype.init = function() {
        i("#basic-datepicker").flatpickr(), i("#datetime-datepicker").flatpickr({
            enableTime: !0,
            dateFormat: "d-m-Y"
        }), i("#basic-datepicker2").flatpickr(), i("#datetime-datepicker2").flatpickr({
            enableTime: !0,
            dateFormat: "d-m-Y H:i"
        }), i("#basic-datepicker3").flatpickr(), i("#datetime-datepicker3").flatpickr({
            enableTime: !0,
            dateFormat: "d-m-Y H:i"
        }), i("#basic-datepicker4").flatpickr(), i("#datetime-datepicker4").flatpickr({
            enableTime: !0,
            dateFormat: "d-m-Y H:i"
        }),i("#basic-datepicker5").flatpickr(), i("#datetime-datepicker5").flatpickr({
            enableTime: !0,
            dateFormat: "d-m-Y H:i"
            ...
            dateFormat: "H:i",
            defaultDate: "01:45"
        }), i("#basic-colorpicker").colorpicker(), i("#hexa-colorpicker").colorpicker({
            format: "auto"
        }), i("#component-colorpicker").colorpicker({
            format: null
        }), i("#horizontal-colorpicker").colorpicker({
            horizontal: !0
        }), i("#inline-colorpicker").colorpicker({
            color: "#DD0F20",
            inline: !0,
            container: !0
        }), i(".clockpicker").clockpicker({
            donetext: "Done"
        }), i("#single-input").clockpicker({
            placement: "bottom",
            align: "left",
            autoclose: !0,
            default: "now"
