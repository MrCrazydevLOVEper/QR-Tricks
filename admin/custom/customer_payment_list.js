$(document).ready(function() {
    ...
    $.when(getCustomerPaymentList()).done(function() {
    ...
    function getCustomerPaymentList() {
        return $.ajax({
            url: base_URL + '/AdminController/getCustomerPaymentList',
            type: 'POST',
            ...
            "aoColumns": [
...

                {
                    "mDataProp": function(data, type, full, meta) {
                            ...
                            return '<a id="' + meta.row + '" href=" '+base_URL +'AdminController/InvoicePaymentUpdate/'+ data['user_id'] +'" class="btn BtnEdit" style="padding:0px;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
                    }
                },
            ]
        });
