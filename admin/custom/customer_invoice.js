$(document).ready(function() {
    ...
    var ourinfoJSON,taxlistJSON,company_info_id,mode,gst_percentage,sgst_percentage, main_total, gst_value, sgst_value;
    var invoice_data = [];
    ...
    function appendproducts(){
        ...
        { 
           ...
           //  $('.tax_type_data').last().append('<div class="col-sm-12">'+
           // '<input class="form-control item_tax_value" name="tax_val[]" readonly style="border:none" value="'+ parseFloat(quantity * tax_value).toFixed(2)  +'">'+
           // '</div>');
           ...
           '</div>'); 
            ...
            sgst_value = 0.00;
            if($('#check_id').is(":checked") == true && ourinfoJSON[0]["state_code"] == 33 ){ 
     ...
     $(document).on('click', "#submit_fynl_order", function() 
        {
            ...
            {
                return $.ajax({
                    url: base_URL+'AdminController/createInvoice',
                    type:'POST',
                    data: {
